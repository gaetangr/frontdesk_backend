    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('document', 'Document'), ('checklist', 'Checklist'), ('planning', 'Planning')], default='document', help_text='Catégories utilisées pour filtrer les fichiers', max_length=20, verbose_name='Catégorie')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_premium', models.BooleanField(default=False, help_text="Si coché, votre établissement dispose d'un compte premium", verbose_name='Premium')),
            ],
            options={
