...
class Notification(TimeStampedModel):
    ...
    sender = models.OneToOneField(User, related_name="sender",blank=True, null=True, on_delete=models.CASCADE)
    receiver = models.ForeignKey(User,related_name="reveiver", on_delete=models.CASCADE)
