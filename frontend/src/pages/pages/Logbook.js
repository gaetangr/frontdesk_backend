/**
 * Display the logbooks for collaborators
 * The form logic and all components related to the logbook
...
const headCells = [
  ...
  { id: "added_by", alignment: "left", label: "Ajouté par" },
...
function Logbook() {
  return (
    <React.Fragment>
      <Helmet title="Registre de maintenance" />
